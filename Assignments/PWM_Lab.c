 ...
 * Duty Cycle Ratio % = CCPR2 / [4*(T2PR+1)]

 * The pre-scale value for the timer is defined in T2CON register. 
 ...
 * 
 * Author: Farid Farahmand; Jessie Lopez (minor editing)
 */

#include <xc.h> // must have this
#include "PWM_Lab.h" // must have this
#include "PWM_Lab_2.h" // must have this -  XC8_ConfigFile.h
